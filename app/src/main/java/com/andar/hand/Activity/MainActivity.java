...
import com.andar.hand.Bean.Connect;
import com.andar.hand.Fragment.EarningsFragment;
import com.andar.hand.Fragment.Help;
import com.andar.hand.Fragment.Map;
import com.andar.hand.Fragment.SummaryFragment;
...
import com.andar.hand.Listeners.ConnectionBooleanChangedListener;
...
//	        }
    ...
    public void logout() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, AccessDetails.serviceurl + URLHelper.LOGOUT, object, new Response.Listener<JSONObject>() {
            @Override
