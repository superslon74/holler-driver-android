...
public class RequestOrderFragment extends Fragment{
    ...
    public static RequestOrderFragment newInstance(String address, int time) {
        ...
        if (addressValues.length<2){
            street = HollerApplication.getInstance().getApplicationContext().getString(R.string.something_went_wrong);
            town = HollerApplication.getInstance().getApplicationContext().getString(R.string.something_went_wrong);
