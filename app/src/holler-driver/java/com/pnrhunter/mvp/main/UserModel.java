...
public class UserModel {
                ...
                .doOnError(throwable -> {
                    ...
                    try {
                        if (((HttpException) error.origin).code() == 422) {
                            String message = HollerApplication.getInstance().getApplicationContext().getString(R.string.error_response_email_exists);
        ...
        serverAPI
                ...
                .doOnError(throwable -> {
                    ...
                    try {
                        ...
                        switch (code) {
                            case 422:
                                String emailExistsMessage = HollerApplication.getInstance().getApplicationContext().getString(R.string.error_response_email_exists);
                                error = new ParsedThrowable(emailExistsMessage, throwable);
                                break;

                            case 403:
                                String phoneExistsMessage = HollerApplication.getInstance().getApplicationContext().getString(R.string.error_response_phone_exists);
    ...
    public static class ParsedThrowable extends Exception {
        ...
        public static ParsedThrowable parse(Throwable throwable) {
            return parse(throwable, HollerApplication.getInstance().getApplicationContext());
        }
