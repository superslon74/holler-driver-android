...
import com.pnrhunter.activity.HistoryDetails;
...
//            TODO: shedule notifications
    ...
    abstract class CallbackErrorHandler<T> implements Callback<T> {
        ...
        public void onUnsuccessfulResponse(retrofit2.Response<T> response) {
            ...
            Log.e("AZAZA","Error data" + response.errorBody());
            switch (response.code()) {
                ...
                case 405:
                case 500:
                    displayMessage(HollerApplication.getInstance().getString(R.string.something_went_wrong));
                    break;
                case 422:
                    displayMessage(HollerApplication.getInstance().getString(R.string.please_try_again));
                    break;
                case 503:
                    displayMessage(HollerApplication.getInstance().getString(R.string.server_down));
                    break;
        ...
        public void onFailure(Call<T> call, Throwable t) {
            ...
            if (t instanceof TimeoutError) {
                ...
                displayMessage(HollerApplication.getInstance().getString(R.string.oops_connect_your_internet));
            }
            onFinishHandling();
        }
